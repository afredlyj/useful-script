...
if __name__=='__main__':
    ...
    client = APIClient(app_key=APP_KEY, app_secret=APP_SECRET, redirect_uri="http://afredlyj.github.io/")
    client.set_access_token('2.00BB3ovBZAVqJEfbdc317513YXwMUC', 157679999)

    response = client.favorites.ids.get(access_token='2.00BB3ovBZAVqJEfbdc317513YXwMUC')
    print response.total_number, response

    for favorited in response.favorites:
        print favorited.status